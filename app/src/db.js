...
function createTables() {
  db.run(`
    ...
    -- ============================================
    -- PREMIUM FEATURES: Cloud Integration Tables
    -- ============================================
    
    -- Cloud drives configuration
    -- Stores user's configured cloud storage locations
    CREATE TABLE IF NOT EXISTS cloud_drives (
      id TEXT PRIMARY KEY,
      name TEXT NOT NULL,
      base_path TEXT NOT NULL,
    ...
    -- Maps JD areas (10-19, 20-29, etc.) to specific cloud drives
    CREATE TABLE IF NOT EXISTS area_storage (
      area_id INTEGER PRIMARY KEY,
      cloud_drive_id TEXT,
      notes TEXT,
    ...
    -- Organization rules for file matching
    -- Defines how to suggest JD destinations for files
    CREATE TABLE IF NOT EXISTS organization_rules (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      name TEXT NOT NULL,
      rule_type TEXT NOT NULL CHECK (rule_type IN ('extension', 'keyword', 'path', 'regex')),
    ...
    -- Organized files tracking
    -- Records files that have been organized through the File Organizer
    CREATE TABLE IF NOT EXISTS organized_files (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      filename TEXT NOT NULL,
      original_path TEXT NOT NULL,
    ...
    -- Holds files from current scan session, cleared between scans
    CREATE TABLE IF NOT EXISTS scanned_files (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      scan_session_id TEXT NOT NULL,
      filename TEXT NOT NULL,
    ...
    -- Watched folders configuration (Premium feature)
    -- Monitors specified directories for new files to organize
    CREATE TABLE IF NOT EXISTS watched_folders (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      name TEXT NOT NULL,
      path TEXT NOT NULL UNIQUE,
    ...
    -- Watch activity log
    -- Tracks all files detected and actions taken by the watcher
    CREATE TABLE IF NOT EXISTS watch_activity (
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      watched_folder_id INTEGER NOT NULL,
      filename TEXT NOT NULL,
