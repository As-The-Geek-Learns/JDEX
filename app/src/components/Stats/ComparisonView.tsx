...
/**
 * Props for ActivityTrend component
 */
...
/**
 * Props for FileTypesCompare component
 */
interface FileTypesCompareProps {
  data: FileTypeData[];
  label: string;
  isPrevious?: boolean;
}
 ...
 */
function calculateDailyAverage(activityByDay: ActivityByDay[] | undefined): number {
 ...
 */
function ActivityTrend({ data, label, color }: ActivityTrendProps): JSX.Element {
