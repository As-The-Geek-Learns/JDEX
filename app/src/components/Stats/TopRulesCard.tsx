...
/**
 * Rule type for organization rules
 */
export type TopRuleType = 'extension' | 'keyword' | 'path' | 'regex';

/**
 * Rule data for display
 */
...
/**
 * Props for the TopRulesCard component
 */
export interface TopRulesCardProps {
  rules?: TopRule[];
  title?: string;
}
...
const ruleTypeIcons: Record<TopRuleType, LucideIcon> = {
  extension: FileText,
  keyword: Hash,
  path: FolderSearch,
  regex: Code,
